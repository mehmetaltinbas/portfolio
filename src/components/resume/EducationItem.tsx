...
export function EducationItem({
    ...
    const startDateFormatted = new Date(education.startDate).toLocaleDateString('en-US', { month: 'short', year: 'numeric' });
    ...
    const displayDescription = shouldTruncate && !isExpanded
        ? education.description!.slice(0, DESCRIPTION_CHAR_LIMIT)
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                        <div className="flex-1">
                            <h3 className="text-lg font-semibold text-gray-900">
                                {education.degree ? `${education.degree}${education.fieldOfStudy ? ` in ${education.fieldOfStudy}` : ''}` : education.fieldOfStudy || 'Education'}
                            </h3>
