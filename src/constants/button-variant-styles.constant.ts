...
export const buttonVariantStyles: Record<ButtonVariant, string> = {
    ...
    [ButtonVariant.SECONDARY]: 'bg-gray-500 text-white border-gray-500 hover:bg-gray-200 hover:text-black',
    [ButtonVariant.DANGER]: 'bg-red-800 text-white border-red-800 hover:bg-white hover:text-red-800 hover:border-red-800',
